...
from prompts.relation_keys import ENHANCE_RELATION_KEYS
...
class RelationKeysResult(BaseModel):
    """关系索引键增强结果 (Pydantic BaseModel，支持 langchain with_structured_output)"""
    keywords: List[str] = Field(description="与实体关系相关的3-5个主题关键词，用于索引和检索")
